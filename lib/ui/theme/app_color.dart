...
class AppColors {
  ...
  static const Color buttonPrimaryBackground = Color.fromRGBO(239, 153, 45, 1.0);

  // Fundo do botão secundário
  static const Color buttonSecondaryBackground = Color.fromRGBO(220, 155, 60, 1.0);

  // Fundo e texto do botão desabilitado
  static const Color buttonDisabledBackground = Color(0xFFBDBDBD); // equivalente ao grey.shade400
  static const Color buttonDisabledText = Color(0xFFEEEEEE);       // equivalente ao grey.shade200
